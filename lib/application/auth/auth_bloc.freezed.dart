...
/// @nodoc
mixin _$AuthState {
  ApiStatus get loginState => throw _privateConstructorUsedError;
...
class _$AuthStateCopyWithImpl<$Res, $Val extends AuthState>
  ...
  @pragma('vm:prefer-inline')
  @override
  $Res call({Object? loginState = null}) {
    return _then(
      _value.copyWith(
...
class _$AuthStateImpl implements _AuthState {
  const _$AuthStateImpl({required this.loginState});

  @override
  final ApiStatus loginState;

  @override
  String toString() {
    return 'AuthState(loginState: $loginState)';
  }
...
abstract class _AuthState implements AuthState {
  const factory _AuthState({required final ApiStatus loginState}) =
      _$AuthStateImpl;

  @override
  ApiStatus get loginState;
